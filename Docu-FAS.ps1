...
.PARAMETER AddDateTime
	...
	Output filename will be ReportName_2022-06-01_1800.<fileextension>.
...
.EXAMPLE
	...
	Will use:
		...
		The computer running the script for the AdminAddress.
.EXAMPLE
	PS C:\PSScript .\Docu-FAS.ps1 -MSWord -CompanyName "Sherlock Holmes 
...
.EXAMPLE
	...
	The timestamp is in the format of yyyy-MM-dd_HHmm.
	June 1, 2022 at 6PM is 2022-06-01_1800.
	Output filename will be CitrixFASInventory_2022-06-01_1800.html.
.EXAMPLE
	...
	The timestamp is in the format of yyyy-MM-dd_HHmm.
	June 1, 2022 at 6PM is 2022-06-01_1800.
	Output filename will be CitrixFASInventory_2022-06-01_1800.pdf.
.EXAMPLE
...
.EXAMPLE
	PS C:\PSScript > .\Docu-FAS.ps1 -SmtpServer mail.domain.tld -From 
    ...
    the script prompts the to enter valid credentials.
.EXAMPLE
	PS C:\PSScript > .\Docu-FAS.ps1 -SmtpServer mailrelay.domain.tld -From 
	...
	***GMAIL/G SUITE SMTP RELAY***
    ...
    account.
.EXAMPLE
	PS C:\PSScript > .\Docu-FAS.ps1 SmtpServer 
...
.EXAMPLE
	PS C:\PSScript > .\Docu-FAS.ps1 -SmtpServer smtp.office365.com -SmtpPort 587
...
.EXAMPLE
	PS C:\PSScript > .\Docu-FAS.ps1 -SmtpServer smtp.gmail.com -SmtpPort 587
	-UseSSL -From Webster@CarlWebster.com -To ITGroup@CarlWebster.com	
...
$Script:ScriptName        = "Docu-FAS.ps1"
