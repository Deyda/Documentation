...
.EXAMPLE
	PS C:\PSScript > .\Docu-XD7.ps1 -AdminAddress DDC01
...
.EXAMPLE
	PS C:\PSScript > .\Docu-XD7.ps1 -PDF
	...
	The computer running the script for the AdminAddress.
.EXAMPLE
	PS C:\PSScript > .\Docu-XD7.ps1 -TEXT
	...
	Administrator for the User Name.
.EXAMPLE
	PS C:\PSScript > .\Docu-XD7.ps1 -HTML
	...
	Administrator for the User Name.
.EXAMPLE
	PS C:\PSScript > .\Docu-XD7.ps1 -MachineCatalogs
	...
	Administrator for the User Name.
.EXAMPLE
	PS C:\PSScript > .\Docu-XD7.ps1 -DeliveryGroups
	...
	Administrator for the User Name.
.EXAMPLE
	PS C:\PSScript > .\Docu-XD7.ps1 -DeliveryGroupsUtilization
	...
	Administrator for the User Name.
.EXAMPLE
	PS C:\PSScript > .\Docu-XD7.ps1 -DeliveryGroups -MachineCatalogs
	...
	Administrator for the User Name.
.EXAMPLE
	PS C:\PSScript > .\Docu-XD7.ps1 -Applications
	...
	Administrator for the User Name.
.EXAMPLE
	PS C:\PSScript > .\Docu-XD7.ps1 -Policies
	...
	Administrator for the User Name.
.EXAMPLE
	PS C:\PSScript > .\Docu-XD7.ps1 -NoPolicies
	...
	Administrator for the User Name.
.EXAMPLE
	PS C:\PSScript > .\Docu-XD7.ps1 -NoADPolicies
	...
	Administrator for the User Name.
.EXAMPLE
	PS C:\PSScript > .\Docu-XD7.ps1 -Policies -NoADPolicies
	...
	Administrator for the User Name.
.EXAMPLE
	PS C:\PSScript > .\Docu-XD7.ps1 -Administrators
	...
	Administrator for the User Name.
.EXAMPLE
	PS C:\PSScript > .\Docu-XD7.ps1 -Logging -StartDate 01/01/2021 -EndDate 01/31/2021
	...
	Administrator for the User Name.
.EXAMPLE
	PS C:\PSScript > .\Docu-XD7.ps1 -Logging -StartDate "06/01/2021 10:00:00" -EndDate 
	"06/01/2021 14:00:00"
	...
	Administrator for the User Name.
.EXAMPLE
	PS C:\PSScript > .\Docu-XD7.ps1 -Hosting
	...
	Administrator for the User Name.
.EXAMPLE
	PS C:\PSScript > .\Docu-XD7.ps1 -StoreFront
	...
	Administrator for the User Name.
.EXAMPLE
	PS C:\PSScript > .\Docu-XD7.ps1 -MachineCatalogs -DeliveryGroups -Applications 
	...
	Administrator for the User Name.
.EXAMPLE
	PS C:\PSScript > .\Docu-XD7.ps1 -MC -DG -Apps -Policies -Hosting
	...
	Administrator for the User Name.
.EXAMPLE
	PS C:\PSScript .\Docu-XD7.ps1 -CompanyName "Carl Webster Consulting" 
...
.EXAMPLE
	PS C:\PSScript .\Docu-XD7.ps1 -CN "Carl Webster Consulting" -CP "Mod" -UN 
	"Carl Webster"
	...
	Uses:
		...
		The computer running the script for the AdminAddress.
.EXAMPLE
	PS C:\PSScript .\Docu-XD7.ps1 -CompanyName "Sherlock Holmes Consulting" 
...
.EXAMPLE
	PS C:\PSScript > .\Docu-XD7.ps1 -AddDateTime
...
.EXAMPLE
	PS C:\PSScript > .\Docu-XD7.ps1 -PDF -AddDateTime
...
.EXAMPLE
	PS C:\PSScript > .\Docu-XD7.ps1 -Hardware
	...
	Administrator for the User Name.
.EXAMPLE
	PS C:\PSScript > .\Docu-XD7.ps1 -Folder \\FileServer\ShareName
...
.EXAMPLE
	PS C:\PSScript > .\Docu-XD7.ps1 -Section Policies
...
.EXAMPLE
	PS C:\PSScript > .\Docu-XD7.ps1 -MaxDetails
	...
	Set the following parameter values:
		...
		Section             = "All"
.EXAMPLE
	PS C:\PSScript > .\Docu-XD7.ps1 -Dev -ScriptInfo -Log
...
.EXAMPLE
	PS C:\PSScript > .\Docu-XD7.ps1 -SmtpServer mail.domain.tld -From 
...
.EXAMPLE
	PS C:\PSScript > .\Docu-XD7.ps1 -SmtpServer mailrelay.domain.tld -From 
	...
	***GMAIL/G SUITE SMTP RELAY***
	...
	account.
.EXAMPLE
	PS C:\PSScript > .\Docu-XD7.ps1 -SmtpServer 
...
.EXAMPLE
	PS C:\PSScript > .\Docu-XD7.ps1 -SmtpServer smtp.office365.com -SmtpPort 587
    ...
    the user to enter valid credentials.
.EXAMPLE
	PS C:\PSScript > .\Docu-XD7.ps1 -SmtpServer smtp.gmail.com -SmtpPort 587 -UseSSL 
...
Function ShowScriptOptions
{
	...
	Write-Verbose "$(Get-Date -Format G): MaxDetails      : $($MaxDetails)"
...
Function OutputMachines
{
	...
	ForEach($Catalog in $Catalogs)
	{
		...
		ElseIf($HTML)
		{
			...
			$rowdata = @()
			$columnHeaders = @("Description",($htmlsilver -bor $htmlbold),$Catalog.Description,$htmlwhite)
			If($Catalog.ProvisioningType -eq "MCS")
			{
...
Function OutputMachineDetails
{
	...
	Write-Verbose "$(Get-Date -Format G): `t`tOutput Desktop Machine $($Machine.HostedMachineName)"
...
Function OutputServerMachineDetails
{
	...
	Write-Verbose "$(Get-Date -Format G): `t`tOutput Server Machine $($Machine.HostedMachineName)"
...
Function OutputDeliveryGroupApplicationDetails 
{
	...
	If($? -and $Null -ne $AllApplications)
	{
		...
		ForEach($Application in $AllApplications)
		{
			...
			Else
			{
				Write-Verbose "$(Get-Date -Format G): `t`tAdding Application $($Application.Name)"
			}
...
Function OutputApplicationDetails
{
	...
	Else
	{
		Write-Verbose "$(Get-Date -Format G): `t`tApplication details for $($Application.Name)"
	}
...
Function OutputApplicationAdministrators
{
	...
	Else
	{
		Write-Verbose "$(Get-Date -Format G): `t`tApplication administrators for $($Application.Name)"
	}
...
Function OutputConfigLog
{
	...
	Write-Verbose "$(Get-Date -Format G): `tOutput Configuration Logging"
	If($MSWord -or $PDF)
	{
...
Function ProcessScriptSetup
{
	...
	If((Get-ConfigRegisteredServiceInstance | Where-Object {$_.ServiceType -eq "Analytics"}).Count -gt 0)
	{
		If(!(Check-NeededPSSnapins "Citrix.Analytics.Admin.V1"))
		{
			...
			`n`n
			`t`t
			Missing Citrix PowerShell Analytics Snap-in Detected, check the console above for more information.
			`n`n
			`t`t
			CEIP will not be shown.
			`n`n
			"
		}
		Else
	...
	Else
	{
		Write-Verbose "$(Get-Date -Format G): `tSQL Server Assembly successefully loaded"
...
Function ProcessScriptEnd
{
	...
	If($ScriptInfo)
	{
		$SIFile = "$Script:pwdpath\XAXD7V1InventoryScriptInfo_$(Get-Date -f yyyy-MM-dd_HHmm).txt"
