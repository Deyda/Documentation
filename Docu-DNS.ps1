...
.PARAMETER To
	...
	If SmtpServer is used, this is a required parameter.
.EXAMPLE
	PS C:\PSScript > .\Docu-DNS.ps1 -MSWord 
...
.EXAMPLE
	PS C:\PSScript > .\Docu-DNS.ps1 -ComputerName DNS01
	...
	Creates a Microsoft Word document.
.EXAMPLE
	PS C:\PSScript > .\Docu-DNS.ps1 -PDF
	...
	Administrator for the Username.
.EXAMPLE
	PS C:\PSScript > .\Docu-DNS.ps1 -TEXT
...
.EXAMPLE
	PS C:\PSScript > .\Docu-DNS.ps1 -ComputerName localhost
...
.EXAMPLE
	PS C:\PSScript > .\Docu-DNS.ps1 -ComputerName 192.168.1.222
	...
	Creates an HTML file.
.EXAMPLE
	PS C:\PSScript .\Docu-DNS.ps1 -CompanyName "Carl Webster Consulting" 
...
.EXAMPLE
	PS C:\PSScript .\Docu-DNS.ps1 -CN "Carl Webster Consulting" -CP "Mod"
...
.EXAMPLE
	PS C:\PSScript > .\Docu-DNS.ps1 -AddDateTime
...
.EXAMPLE
	PS C:\PSScript > .\Docu-DNS.ps1 -PDF -AddDateTime
...
.EXAMPLE
	PS C:\PSScript > .\Docu-DNS.ps1 -Folder \\FileServer\ShareName
	
	The output HTML file is saved in the path \\FileServer\ShareName.
.EXAMPLE
	PS C:\PSScript > .\Docu-DNS.ps1 -Details -MSWord
...
.EXAMPLE
	PS C:\PSScript > .\Docu-DNS.ps1 -SmtpServer mail.domain.tld -From 
...
.EXAMPLE
	PS C:\PSScript > .\Docu-DNS.ps1 -SmtpServer mailrelay.domain.tld -From 
	...
	***GMAIL/G SUITE SMTP RELAY***
	...
	account.
.EXAMPLE
	PS C:\PSScript > .\Docu-DNS.ps1 -SmtpServer 
...
.EXAMPLE
	PS C:\PSScript > .\Docu-DNS.ps1 -SmtpServer smtp.office365.com -SmtpPort 587
	...
	the user will be prompted to enter valid credentials.
.EXAMPLE
	PS C:\PSScript > .\Docu-DNS.ps1 -SmtpServer smtp.gmail.com -SmtpPort 587
	-UseSSL -From Webster@CarlWebster.com -To ITGroup@CarlWebster.com	
...
$Script:ScriptName        = "Docu-DNS.ps1"
